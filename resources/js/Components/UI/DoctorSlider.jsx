...
export default function DoctorSlider({ doctors, onAddNew }) {
    const [currentIndex, setCurrentIndex] = useState(0);
    const itemsPerPage = 6;
    const totalPages = Math.ceil((doctors.length + 1) / itemsPerPage);
    ...
    const getCurrentItems = () => {
        ...
        const allItems = [...doctors];

        allItems.push({ id: "add-new", isAddNew: true });
